            ...
            while (redCount > 0 && blackCount > 0)
            {
                ...
                if (turnCount % 2 == 1)
                {
                    ...
                    while (!done)
                    {
                        ...
                        if (selectedPiece < 0)
                        { //if the selected piece is a red (invalid) square
                            Console.WriteLine("Invalid move, try again.");
                            pause();
                        }
                        else if ((piecePos[0] < 0 || piecePos[0] > 7) || (piecePos[1] < 0 || piecePos[1] > 7))
                        { //if the selected piece index is outside of bound of the board, then invalid move
                            Console.WriteLine("Invalid move, try again.");
                            pause();
                        }
                        ...
                        { //if the new position is more than 2 spaces away from the original, then invalid move
                            Console.WriteLine("Invalid move, try again.");
                            pause();
                        }
                        else if (!(rowAbs == colAbs))
                        { //if the new position is not a square in a diagonal line from the original, then invalid move
                            Console.WriteLine("Invalid move, try again.");
                            pause();
                        }
                        else if ((rowAbs == 2 && colAbs == 2) && (board[rowMid, colMid] % 2 == 1 || board[rowMid, colMid] == 0))
                        { //if a jump is attempted and the jump is not over an opposite
                        ...
                        { //if a jump is attempted and good
                        ...
                        { //else the player moved one space forward and the selected piece is moved and the turn is ended
                        ...
                        while (again)
                        {
                            ...
                            if (again)
                            {
                                ...
                                { //if the move is anything other than a jump over the opposite player's piece, then invalid move
                                    Console.WriteLine("Invalid move, try again.");
                                    pause();
                                }
                                else
                                { //else the move is a jump over the opposite player's piece, so execute
